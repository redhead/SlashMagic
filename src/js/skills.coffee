class Skills
	...
	@database: [
		...
		},
		{
			"name": "Jezdectví",
			"type": "physical",
			"description1": "Bonus: +4
	Postih k boji: -4",
			"description2": "Bonus: +6
	Postih k boji: -2",
			"description3": "Bonus: +8
	Postih k boji: 0",
		...
		},
		{
			...
			"description": "Bonus využiješ v hodu na kování:
	Zrč + Kovářství + 2k6*."
		},
		{
			"name": "Letectví",
	...
	Postih k boji: 0",
		...
		},
		{
			"name": "Plavání",
			"type": "physical",
			"description1": "Bonus k plavání: +4
	Bonus k Rch: +2",
			"description2": "Bonus k plavání: +6
	Bonus k Rch: +3",
			"description3": "Bonus k plavání: +8
	Bonus k Rch: +4",
		...
		},
		{
			...
			"type": "physical",
			"description1": "Bonus k Rch: +1
	Bonus k Int nebo Sms: +2",
			"description2": "Bonus k Rch: +2
	Bonus k Int nebo Sms: +4",
			"description3": "Bonus k Rch: +3
	Bonus k Int nebo Sms: +6",
	...
	Bonus k orientaci: +3",
		...
		},
		{
			...
			"description2": "Bonus: +4",
			"description3": "Bonus: +6",
			"description": "Umožňuje postavě nejen kreslit, ale i číst a orientovat se podle map.
	Kvalita mapy = Zrč + Kreslení map + 2k6*
	Hod na použití = Int + Kreslení map + 2k6*
	Užitečná kvalita = Nižší z Hodu na použití a Kvality mapy
	Bonus k navigaci = Užitečná kvalita / 6"
		},
		{
	...
	Bonus k Sms: +3",
		...
		},
		{
			"name": "Teologie",
			"type": "psychic",
			"description1": "Postava zná základní náboženství v kraji.

	Bonus k Int: +3",
			"description2": "Postava již chápe některé vztahy mezi církvemi.

	Bonus k Int: +6",
			"description3": "Postava již chápe většinu církevní politiky i chování, které vyžadují.
	...
	Bonus k Int: +9",
		...
		},
		{
			...
			"type": "psychic",
			"description1": "Bonus k Int: +3
	Bonus k ÚČ, Krytu a ZZ: +1",
			"description2": "Bonus k Int: +6
	Bonus k ÚČ, Krytu a ZZ: +2",
			"description3": "Bonus k Int: +9
	Bonus k ÚČ, Krytu a ZZ: +3",
		...
		},
		{
			"name": "Bylinkářství",
			"type": "combined",
			"description1": "Bonus k Sms: +6
	Bonus k Int: +3",
			"description2": "Bonus k Sms: +9
	Bonus k Int: +6",
			"description3": "Bonus k Sms: +12
	Bonus k Int: +9",
		...
		},
		{
			...
			"description": "Dovednost použij při hraní představení pro své přátele (nebo třeba vesničany).

	Kvalita hry = Chr + Herectví + 2k6*"
		},
		{
			...
			"description2": "Bonus: +6",
			"description3": "Bonus: +9",
			"description": "Platí pro jeden druh nástroje.

	Kvalita hry = Zrč + Hra na hudební nástroj + 2k6*"
		},
		{
			"name": "Lov a rybolov",
			"type": "combined",
		...
		},
		{
			...
			"description2": "Bonus: +6",
			"description3": "Bonus: +9",
			"description": "Postava dokáže namalovat obraz od základních tvarů až po velice detailní postavy, místa nebo předměty.

	Kvalita obrazu = Zrč + Malování + 2k6*"
		},
		{
			"name": "První pomoc",
			"type": "combined",
			"description1": "Síla léčení běžného zranění: -6
	Snížení velikosti krvácení: --
	Snížení velikosti jedu: --",
			"description2": "Síla léčení běžného zranění: -4
	Snížení velikosti krvácení: -1
	Snížení velikosti jedu: --",
			"description3": "Síla léčení běžného zranění: -2
	Snížení velikosti krvácení: -2
	Snížení velikosti jedu: -2",
		...
		},
		{
			...
			"description2": "Bonus: +6",
			"description3": "Bonus: +9",
			"description": "Nejedná se jen o tesání do kamene, ale i o veškeré modelování pevných materiálů, to znamená kovů, dřeva, hlíny a jiných. Postava má cit v rukou a hrubou představu o tom, jak bude materiál na doteky reagovat.

	Kvalita sochy = Zrč + Sochařství + 2k6*"
		},
		{
			"name": "Svádění",
			"type": "combined",
		...
		},
		{
			...
			"description2": "Bonus: +6",
			"description3": "Bonus: +9",
			"description": "Bonus použij při hodu na kvalitu tance, který ukáže, jakým uměleckým dojmem se postavě podařilo zapůsobit na obecenstvo a na partnera.

	Kvalita tance = Obr + Tanec + 2k6*"
		},
		{
			"name": "Uzlování",
			"type": "combined",
		...
		},
		{
			...
			"description2": "Bonus: +4",
			"description3": "Bonus: +6",
			"description": "Bonus se přičítá k hodu na kvalitu pokrmu. Tím se určuje, jak dobrý pokrm se postavě podařilo uvařit a zda hostům chutnal.

	Kvalita pokrmu = Zrč + Vaření + 2k6*"
		},
		{
		...
		},
		{
			...
			"description2": "Bonus: +6",
			"description3": "Bonus: +9",
			"description": "Bonus použij v hodu na kvalitu zpívaného nebo recitovaného textu, při imitacích a dalších situacích, kdy je schopnost ovládat svoje hlasivky důležitá (třeba i hlasité zakřičení). Na III. stupni se můžeš pokusit napodobit i zpěv ptáka.

	Kvalita zpěvu = Zrč + Zpěv + 2k6*"
		}
	]
